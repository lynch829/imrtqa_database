function varargout = D_tomooptimodfactor(varargin)

% If no inputs are provided, return plot name
if nargin == 0
    varargout{1} = 'TomoTherapy Optimization Mod Factor';
    return;
else
    stats = [];
    for i = 1:2:nargin
...
% Query TomoTherapy optimization MF and date
data = db.queryColumns('tomo', 'optimod', ...
...
plot((e(1):0.001:e(end)), interp1(e(1:end-1), d, ...
    ...
    'LineWidth', 2);
xlabel('Optimization Modulation Factor');
ylabel('Occurrence');
box on;
grid on;
